...
public class OpenStreetMapTest extends Sprite
{
    ...
    public function OpenStreetMapTest()
    {
...
//        transformer.easing = "easeOutSine"
        ...
        scaleConstraint.maxScale = new OpenStreetMapDescriptor().width / container.sceneWidth
    ...
    private function request_completeHandler(event:NetworkRequestEvent):void
    {
        event.request.removeEventListener(NetworkRequestEvent.COMPLETE,
                                          request_completeHandler)
        descriptor = new OpenStreetMapDescriptor()
...
class NeoRenderer extends Renderer
{
    ...
    private var app:OpenStreetMapTest
     ...
     * Constructor.
     */
    public function NeoRenderer(app:OpenStreetMapTest, width:Number, height:Number)
    {
        this.app = app
